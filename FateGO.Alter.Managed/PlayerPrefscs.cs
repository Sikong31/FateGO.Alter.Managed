...
namespace PreviewLabs
{
    public static class PlayerPrefs
    {
        ...
        private static readonly string fileName = Application.persistentDataPath + "/FGOTweakPrefs.txt";
        ...
        private static byte[] bytes = ASCIIEncoding.ASCII.GetBytes("anpq" + SystemInfo.deviceUniqueIdentifier.Substring(0, 4));
